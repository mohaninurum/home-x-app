...
class _ClockCustomizationScreenState extends ConsumerState<ClockCustomizationScreen> with SingleTickerProviderStateMixin {
  ...
  final List<Map<String, dynamic>> presets = [
    ...
    {
      'name': 'The Bleeding Eye',
      'customization': ClockCustomization(
        dialType: DialType.numberAndDashes,
        backgroundColorValue: Colors.red.value,
        hourHandColorValue: Colors.yellowAccent.value,
        minuteHandColorValue: Colors.greenAccent.value,
        secondHandColorValue: Colors.cyanAccent.value,
        numberColorValue: Colors.white.value,
        hourDashColorValue: Colors.yellowAccent.value,
        minuteDashColorValue: Colors.blueAccent.value,
        centerDotColorValue: Colors.pinkAccent.value,
        neoEffectEnabled: true,
        neoBorderWidth: 8.0,
      ),
    },
    {
    ...
    },
    {
      ...
      'customization': ClockCustomization(
        dialType: DialType.numberAndDashes,
        backgroundColorValue: Colors.limeAccent.value,
        hourHandColorValue: Colors.deepPurple.value,
        minuteHandColorValue: Colors.pinkAccent.value,
        secondHandColorValue: Colors.orange.value,
        numberColorValue: Colors.red.value,
        hourDashColorValue: Colors.blue.value,
        minuteDashColorValue: Colors.cyan.value,
        centerDotColorValue: Colors.brown.value,
        borderColorValue: Colors.pink.value,
        borderWidth: 10.0,
        neoEffectEnabled: true,
        neoBorderWidth: 15.0,
      ),
    ...
    },
    {
      ...
      'customization': ClockCustomization(
        ...
        hourHandColorValue: Colors.yellowAccent.value,
        minuteHandColorValue: Colors.white70.value,
        secondHandColorValue: Colors.amberAccent.value,
        numberColorValue: Colors.yellow.value,
        hourDashColorValue: Colors.white24.value,
        minuteDashColorValue: Colors.yellow.value,
        centerDotColorValue: Colors.white.value,
        neoEffectEnabled: true,
        neoBorderWidth: 20.0,
        borderColorValue: Colors.white.value,
        borderWidth: 10.0,
      ),
    },
  ];
