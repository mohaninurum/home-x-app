...
class _ClockCustomizationScreenState extends ConsumerState<ClockCustomizationScreen> with SingleTickerProviderStateMixin {
  ...
  final List<Map<String, dynamic>> presets = [
    ...
    },
    {
      ...
      'customization': ClockCustomization(
        dialType: DialType.numbers,
        backgroundColorValue: Colors.pinkAccent.value,
        hourHandColorValue: Colors.greenAccent.value,
        minuteHandColorValue: Colors.yellowAccent.value,
        secondHandColorValue: Colors.deepOrangeAccent.value,
        numberColorValue: Colors.black.value,
        centerDotColorValue: Colors.red.value,
        extendHourHand: true,
        extendMinuteHand: true,
      ),
    },
    {
      'name': "Procrastinator's",
      'customization': ClockCustomization(
        dialType: DialType.dashes,
        backgroundColorValue: Colors.transparent.value,
        hourHandColorValue: Colors.transparent.value,
        minuteHandColorValue: Colors.transparent.value,
        secondHandColorValue: Colors.redAccent.value,
        hourDashColorValue: Colors.transparent.value,
        minuteDashColorValue: Colors.transparent.value,
        centerDotColorValue: Colors.transparent.value,
        numberColorValue: Colors.transparent.value,
    ...
    },
    {
      ...
      'customization': ClockCustomization(
        ...
        hourHandColorValue: Colors.transparent.value,
        minuteHandColorValue: Colors.transparent.value,
        secondHandColorValue: Colors.transparent.value,
        hourDashColorValue: Colors.transparent.value,
        minuteDashColorValue: Colors.transparent.value,
        centerDotColorValue: Colors.grey.withOpacity(0.5).value,
        numberColorValue: Colors.transparent.value,
        showSecondHand: false,
      ),
    },
    {
      ...
      'customization': ClockCustomization(
        dialType: DialType.numbers,
        backgroundColorValue: Colors.yellowAccent.value,
        hourHandColorValue: Colors.pinkAccent.value,
        minuteHandColorValue: Colors.cyanAccent.value,
        secondHandColorValue: Colors.lightGreenAccent.value,
        hourDashColorValue: Colors.purpleAccent.value,
        numberColorValue: Colors.deepPurpleAccent.value,
        centerDotColorValue: Colors.orangeAccent.value,
        extendMinuteHand: true,
      ),
    },
  ];
