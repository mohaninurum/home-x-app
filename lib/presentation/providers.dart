...
final uploadingIconsProvider =
    NotifierProvider<UploadingIconsNotifier, Set<String>>(() {
...
final hiddenAppsProvider =
    AsyncNotifierProvider<HiddenAppsNotifier, Set<String>>(
      () => HiddenAppsNotifier(),
    );
...
final homeScreenNeoProvider =
    AsyncNotifierProvider<NeoScreenBorderNotifier, HomeScreenNeoSettings>(() {
